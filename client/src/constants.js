...
export const LICORES = [
  ...
  // ── Cacique ──
  { id: 'lic_cacique_litro', name: 'Cacique Litro', category: 'alcoholic', categoria: 'Cacique', presentaciones: [{ id: 've', label: 'Venta', price: 10000 }, { id: 'tp', label: 'Trago Pequeño', price: 1000 }, { id: 'tg', label: 'Trago Grande', price: 1500 }, { id: 'cu', label: 'Cuarto', price: 4000 }, { id: 'me', label: 'Media', price: 6000 }, { id: 'li', label: 'Litro', price: 12000 }] },
  { id: 'lic_cacique_ligao', name: 'Cacique Ligao', category: 'alcoholic', categoria: 'Cacique', presentaciones: [{ id: 've', label: 'Venta', price: 10000 }, { id: 'tp', label: 'Trago Pequeño', price: 1000 }, { id: 'tg', label: 'Trago Grande', price: 1500 }, { id: 'cu', label: 'Cuarto', price: 4000 }, { id: 'me', label: 'Media', price: 6000 }, { id: 'li', label: 'Litro', price: 12000 }] },
  ...
  { id: 'lic_chivas_regal', name: 'Chivas Regal', category: 'alcoholic', categoria: 'Whisky', presentaciones: [{ id: 've', label: 'Venta', price: 35000 }, { id: 'tp', label: 'Trago Pequeño', price: 2500 }, { id: 'tg', label: 'Trago Grande', price: 4000 }, { id: 'cu', label: 'Cuarto', price: 12000 }, { id: 'me', label: 'Media', price: 17000 }, { id: 'li', label: 'Litro', price: 50000 }] },
  { id: 'lic_old_parr', name: 'Old Parr', category: 'alcoholic', categoria: 'Whisky', presentaciones: [{ id: 've', label: 'Venta', price: 35000 }, { id: 'tp', label: 'Trago Pequeño', price: 2500 }, { id: 'tg', label: 'Trago Grande', price: 4000 }, { id: 'cu', label: 'Cuarto', price: 12000 }, { id: 'me', label: 'Media', price: 17000 }, { id: 'li', label: 'Litro', price: 50000 }] },
  ...
  { id: 'lic_johnnie_walker_black', name: 'Johnnie Walker Black', category: 'alcoholic', categoria: 'Whisky', presentaciones: [{ id: 've', label: 'Venta', price: 35000 }, { id: 'tp', label: 'Trago Pequeño', price: 2500 }, { id: 'tg', label: 'Trago Grande', price: 4000 }, { id: 'cu', label: 'Cuarto', price: 10000 }, { id: 'me', label: 'Media', price: 15000 }, { id: 'li', label: 'Litro', price: 40000 }] },
  ...
  { id: 'lic_centenario', name: 'Centenario', category: 'alcoholic', categoria: 'Ron', presentaciones: [{ id: 've', label: 'Venta', price: 18000 }, { id: 'tp', label: 'Trago Pequeño', price: 1500 }, { id: 'tg', label: 'Trago Grande', price: 2500 }, { id: 'cu', label: 'Cuarto', price: 7000 }, { id: 'me', label: 'Media', price: 10000 }, { id: 'li', label: 'Litro', price: 23000 }] },
  { id: 'lic_jarana_clara', name: 'Jarana Clara', category: 'alcoholic', categoria: 'Tequila', presentaciones: [{ id: 've', label: 'Venta', price: 20000 }, { id: 'tp', label: 'Trago Pequeño', price: 2000 }, { id: 'tg', label: 'Trago Grande', price: 3000 }, { id: 'cu', label: 'Cuarto', price: 10000 }, { id: 'me', label: 'Media', price: 15000 }, { id: 'li', label: 'Litro', price: 27000 }] },
  { id: 'lic_jarana_oscura', name: 'Jarana Oscura', category: 'alcoholic', categoria: 'Tequila', presentaciones: [{ id: 've', label: 'Venta', price: 20000 }, { id: 'tp', label: 'Trago Pequeño', price: 2000 }, { id: 'tg', label: 'Trago Grande', price: 3000 }, { id: 'cu', label: 'Cuarto', price: 10000 }, { id: 'me', label: 'Media', price: 15000 }, { id: 'li', label: 'Litro', price: 27000 }] },
  ...
  { id: 'lic_something', name: 'Something Special', category: 'alcoholic', categoria: 'Whisky', presentaciones: [{ id: 've', label: 'Venta', price: 20000 }, { id: 'tp', label: 'Trago Pequeño', price: 2000 }, { id: 'tg', label: 'Trago Grande', price: 3500 }, { id: 'cu', label: 'Cuarto', price: 8000 }, { id: 'me', label: 'Media', price: 13000 }, { id: 'li', label: 'Litro', price: 30000 }] },
  ...
  { id: 'lic_rose', name: 'Tequila Rosé', category: 'alcoholic', categoria: 'Tequila', presentaciones: [{ id: 've', label: 'Venta', price: 27000 }, { id: 'tp', label: 'Trago Pequeño', price: 2500 }, { id: 'tg', label: 'Trago Grande', price: 4000 }, { id: 'cu', label: 'Cuarto', price: 12000 }, { id: 'me', label: 'Media', price: 18000 }, { id: 'li', label: 'Litro', price: 36000 }] },
];
...
export const MENU = {
  bar: {
    ...
    'Comida rápida': [
      ...
      { id: 'f_chalupas_carne', name: 'Chalupas de carne', price: 3000, category: 'food' },
      { id: 'f_chalupas_pollo', name: 'Chalupas de pollo', price: 2800, category: 'food' },
      { id: 'f_chalupas_mixtas', name: 'Chalupas mixtas', price: 3300, category: 'food' },
      { id: 'f_salchipapas', name: 'Salchipapas', price: 2800, category: 'food' },
      { id: 'f_filet_pescado', name: 'Filet de pescado', price: 3300, category: 'food' },
      { id: 'f_burritos_carne', name: 'Burritos de carne', price: 4000, category: 'food' },
      { id: 'f_burrito_pollo', name: 'Burrito de pollo', price: 3900, category: 'food' },
      { id: 'f_burrito_mixto', name: 'Burrito mixto', price: 4300, category: 'food' },
      { id: 'f_fajitas_emp', name: 'Fajitas empanizadas', price: 3900, category: 'food' },
      { id: 'f_fajitas_pollo', name: 'Fajitas de pollo', price: 3900, category: 'food' },
